...
const suggestionPage = () => {
  ...
  // İçerik görsel URL'si
  let imageUrl = id ? `https://picsum.photos/id/101${id}/400/600` : "";

  const incrementedId = id ? parseInt(id) - 7 : "";

  if (id === "10") {
    // id'si 10 olan görsel için özel URL
          ...
          {id ? (
            <>
              ...
              <div className="mt-6 lg:mt-0 max-w-lg">
                ...
                >
                  Dizi Film İçeriği: {incrementedId}
                </motion.h1>
                <motion.p
