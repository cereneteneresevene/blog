...
const TravelPage = () => {
  ...
  // Gezi içeriğine özel sabit görsel URL'sini oluştur
  const imageUrl = id ? `https://picsum.photos/id/101${id}/400/600` : "";

  const incrementedId = id ? parseInt(id) + 1 : "";
